...
% additional info (lehner 2013); use the following command to make sure, axis lines and tick marks (i.e.,
% anything that follows the jbfill command) will be on top and visible:
% set(gca,'Layer','top')
